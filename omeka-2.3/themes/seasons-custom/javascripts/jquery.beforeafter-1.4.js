...
(function($){
	$.fn.extend({ 
		...
		var randID =  Math.round(Math.random()*100000000);
			...
			$(obj).prepend('<div id="dragwrapper'+randID+'"><div id="drag'+randID+'"><img width="8" height="56" alt="handle" src="http://omekadev.lib.vt.edu/themes/berlin-custom-Current/images/handle.gif" id="handle'+randID+'" /></div></div>'); // Create drag handle
			...
			$(obj).append('<img src="http://omekadev.lib.vt.edu/themes/berlin-custom-Current/images/lt-small.png" width="7" height="15" id="lt-arrow'+randID+'"><img src="http://omekadev.lib.vt.edu/themes/berlin-custom-Current/images/rt-small.png" width="7" height="15" id="rt-arrow'+randID+'">');
