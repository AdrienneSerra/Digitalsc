		...
		var current			= 0, 
			...
			_showImage		= function( jQueryitem ) {
				...
				jQuery('.zoom-image').click(
					...
					jQueryrgGallery.find('div.rg-zoom-tips').text('Click on the image to magnify, scroll to adjust the zoom, click on the image thumbnail above to remove the magnifier');
